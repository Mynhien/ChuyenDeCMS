...
?>>
		...
		<input type="hidden" id="originalaction" name="originalaction"
			value="<?php echo esc_attr( $form_action ); ?>" />
...
?>
	...
	?>
							...
							<input type="text" name="post_title" size="30"
								...
								autocomplete="off" />
<input type="email" name="post_email" size="15" value="<?php echo esc_attr( $post->post_email ); ?>" id="email" spellcheck="true" autocomplete="off" placeholder="Enter email" style="    padding: 3px 8px;font-size: 1.7em;line-height: 100%;height: 1.7em;width: 50%;"/>
						</div>
